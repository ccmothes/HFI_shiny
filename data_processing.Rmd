...
zonal_ipcc_all <- map(c(hfi_1999, hfi_2023), ~ terra::zonal(.x, ipcc_poly, fun = "mean", na.rm = TRUE))

zonal_country_all <- map(c(hfi_1999, hfi_2023), ~ terra::zonal(.x, country_poly, fun = "mean", na.rm = TRUE))
