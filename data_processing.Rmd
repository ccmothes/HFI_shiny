...
zonal_ipcc_all <- map(annual, ~ terra::zonal(.x, ipcc_poly, fun = "mean", na.rm = TRUE))

zonal_country_all <- map(annual, ~ terra::zonal(.x, country_poly, fun = "mean", na.rm = TRUE))
